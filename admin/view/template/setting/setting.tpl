            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <div id="tab-general">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td><input size="100" type="text" name="config_information" value="<?php echo $config_information; ?>" /></td>
                        </tr>
                        <tr>
                            <td><?php echo $entry_footer; ?></td>
                            <td><textarea name="config_info_footer" cols="40" rows="5"><?php echo $config_info_footer; ?></textarea>
                            </td>
                        </tr>
                        <script type="text/javascript" src="view/javascript/ckeditor/ckeditor.js"></script> 
                        <script type="text/javascript"><!--
                                CKEDITOR.replace('config_info_footer', {
                ...
                <div id="tab-image">
                    <table class="form">
                        ...
                        <tr>
                            <td><?php echo $entry_header_backgroud; ?></td>
                            <td><div class="image"><img src="<?php echo $header_backgroud; ?>" alt="" id="thumb-header_backgroud" />
                                    <input type="hidden" name="config_header_backgroud" value="<?php echo $config_header_backgroud; ?>" id="header_backgroud" />
                                    <br />
                                    <a onclick="image_upload('header_backgroud', 'thumb-header_backgroud');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-header_backgroud').attr('src', '<?php echo $no_image; ?>'); $('#header_backgroud').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
                        </tr>
                        <tr>
